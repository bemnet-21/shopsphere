...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className='w-full  bg-softBlue border border-lightBlue rounded-2xl flex px-4 py-5 gap-x-4 mb-4 md:h-96 md:flex-col md:items-center md:w-64 md:gap-y-2'>
